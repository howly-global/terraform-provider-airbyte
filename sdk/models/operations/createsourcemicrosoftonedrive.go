...
func (o *CreateSourceMicrosoftOnedriveResponse) GetSourceResponse() *shared.SourceResponse {
	if o == nil {
		return nil
	}
...
func (o *CreateSourceMicrosoftOnedriveResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
