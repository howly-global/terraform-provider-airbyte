...
func (o *CreateSourceMicrosoftSharepointResponse) GetSourceResponse() *shared.SourceResponse {
	if o == nil {
		return nil
	}
...
func (o *CreateSourceMicrosoftSharepointResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
