...
func (o *SourceHarvestAuthenticateViaHarvestOAuth) GetAdditionalProperties() any {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
...
func (u *SourceHarvestAuthenticationMechanism) UnmarshalJSON(data []byte) error {
	...
	var sourceHarvestAuthenticateViaHarvestOAuth SourceHarvestAuthenticateViaHarvestOAuth = SourceHarvestAuthenticateViaHarvestOAuth{}
